...
extension UIColor {
  ...
  @nonobjc class var gray8: UIColor {
  ...
  @nonobjc class var bluePurpleOpacity22: UIColor {
    return UIColor(red: 43.0 / 255.0, green: 29.0 / 255.0, blue: 214.0 / 255.0, alpha: 0.22)
  }
  @nonobjc class var gray1: UIColor {
    return UIColor(red: 165.0 / 255.0, green: 165.0 / 255.0, blue: 187.0 / 255.0, alpha: 1.0)
  }
  @nonobjc class var bluePurpleText: UIColor {
    return UIColor(red: 55.0 / 255.0, green: 38.0 / 255.0, blue: 248.0 / 255.0, alpha: 1.0)
  }
  @nonobjc class var bluePurpleOpacity70: UIColor {
    return UIColor(red: 61.0 / 255.0, green: 23.0 / 255.0, blue: 211.0 / 255.0, alpha: 0.7)
  }
}
