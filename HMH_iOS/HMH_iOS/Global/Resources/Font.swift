...
extension UIFont {
    class var iosTitle1Semibold32: UIFont {
        return UIFont(name: "Pretendard-SemiBold", size: 32.0)!
    }
    class var iosTitle2Semibold24: UIFont {
        return UIFont(name: "Pretendard-SemiBold", size: 24.0)!
    }
    class var iosTitle3Semibold22: UIFont {
        return UIFont(name: "Pretendard-SemiBold", size: 22.0)!
    }
    class var iosTitle4Semibold20: UIFont {
    ...
    class var iosDetail2Semibold13: UIFont {
        return UIFont(name: "Pretendard-SemiBold", size: 13.0)!
    }
    class var iosDetail3Semibold12: UIFont {
        return UIFont(name: "Pretendard-SemiBold", size: 12.0)!
    }
    class var iosDetail4Medium12: UIFont {
